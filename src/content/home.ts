/**
 * Homepage narrative copy — written to read as one continuous story rather
 * than a stack of independent sections: Dream -> Transformation -> Pool ->
 * Outdoor Living -> Family -> Landscape -> After Dark -> Why Us -> Areas ->
 * Final CTA, per the brand doc's "Homepage Scroll Story."
 */
...
export const showcaseScenes = [
  ...
  {
    id: "family",
    eyebrow: "The Reason We Do This",
    headlinePrefix: "Built for the moments ",
    headlineEmphasis: "that matter most.",
    copy: "Pool days that run long. Quiet evenings that run longer. Every space we design earns its place by how often your family actually uses it.",
    alt: "Family enjoying a luxury backyard oasis",
  },
  {
    id: "landscape-design",
...
export const serviceAreasTeaser = {
  headline: "Serving custom pool & landscape clients across the East Valley",
};

export const finalCta = {
  headlinePrefix: "Let\u2019s Build ",
  headlineEmphasis: "Your Paradise",
  copy: "Tell us about the backyard you keep picturing. We\u2019ll turn the first conversation into a real design plan.",
